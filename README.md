...
Labadmin is a Linux software, based on Bash shellcript, capable to remotely admin a set of hosts running Linux or Windows. It's an approach similar to Ansible, but Labadmin is focused to work in educational environment controlling hosts in a computer laboratory. 
...
## Controlled hosts install (Windows)
