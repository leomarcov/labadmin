# labadmin
Labadmin is Linux Bash script for remotely admin Linux and Windows hosts in a computer lab environment. It's an approach similar to Ansible, but Labadmin is focused to educational environment and incorporate a full set of actions ready to use (currently 113 actions for Linux and 40 for Windows). 
