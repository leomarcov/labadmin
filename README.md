...
## Discover
Discover stage search for each host MAC in config file his current IP and checks the net state (OFF, ON and listening in configured port or ON but not listening in config port).
