...
For create a new action only need:
  * Create a script file following the labadmin interface. You can use template action located in (doc/screen_template).
  * Save the script file in ``scripts/ssh`` or ``scripts/winrm`` directory.
