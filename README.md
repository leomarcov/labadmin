...
## Discover
Discover stage search current IP for each host MAC in config file and checks the net state (OFF, ON and listening in configured port or ON but not listening).
